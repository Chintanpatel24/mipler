        ...
        <div className="flex items-center gap-1">
          {cardTypes.map(({ type, label, icon }) => (
            <button
              ...
              className="flex items-center gap-1 px-2 py-1 text-xs text-wall-textMuted hover:text-wall-text hover:bg-wall-card rounded transition-colors"
          ...
          >
            <span>🔗</span>
            <span className="hidden lg:inline">Custom URL</span>
          </button>
        </div>
          ...
          {showMenu && (
            <>
              ...
              <div className="absolute right-0 top-full mt-1 z-50 w-48 bg-wall-surface border border-wall-cardBorder rounded-lg shadow-xl py-1 animate-fade-in">
                ...
                >
                  <span className="opacity-50">↑</span> Export Project
                </button>
                <button
                  onClick={() => {
                  ...
                  className="w-full px-3 py-2 text-left text-sm text-wall-text hover:bg-wall-card transition-colors flex items-center gap-2"
                >
                  <span className="opacity-50">↓</span> Import Project
                </button>
                ...
                >
                  <span className="opacity-50">✕</span> Clear Workspace
                </button>
              </div>
            </>
          )}
